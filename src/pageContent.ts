  ...
  ko: {
    'how-to': {
      ...
      sections: [
        ...
        { title: '02. 스티커를 놓고 움직이기', image: guide + 'studio.png', alt: '온실에 스티커를 배치한 작업실과 오른쪽 스티커 서랍', caption: '서랍에서 스티커를 누르면 장면에 추가됩니다. 배치한 스티커를 끌어 옮겨보세요.', paragraphs: ['스티커 서랍에서 원하는 것을 고르세요. 클릭하거나 탭하면 장면에 추가됩니다. PC에서는 서랍에서 장면으로 드래그해 놓을 수도 있습니다.', '장면에 놓은 스티커는 서랍에서 사라지고, 작품에서 삭제하면 원래 목록에 다시 나타납니다. 추가한 스티커를 누른 채 움직여 위치를 바꿀 수 있습니다. 휴대폰에서는 장면 아래 서랍을 이용합니다.'] },
